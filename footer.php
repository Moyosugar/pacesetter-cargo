...
<div class="row mt-5">
            ...
            <div class="px-1">
                <div class="container">
                  <div class="logo-img mb-4">
                     <img src="app-assets/img/logos/logo.png" alt="Logo"/>
                  </div>
                  <div class="media-body white text-left mt-2">
                     <h5 class="red font-medium-3  mb-3">Don't miss out on announcements!</h5>
                  </div>
                  <div class="">
    ...
    <ul class="navbar-nav">
       <li class="nav-item mt-1">
          <a  href="oyostate.php"  class="">Oyo State</a>
       </li>
       <li class="nav-item mt-1">
          <a  href="transport.php"  class="">Transport</a>
       </li>
       <li class="nav-item mt-1">
...
<div class="row mt-5">
                ...
                <div class="container">
                    <div class="">
                            <ul class="list-inline">
                                <a href=""><li class="list-inline-item red">Facebok&nbsp;&nbsp;</li></a>
                                <a href=""><li class="list-inline-item red">Twitter&nbsp;&nbsp;</li></a>
                                <a href=""><li class="list-inline-item red">Instagram</li></a>
                            </ul>
                        </div>
                </div>
            </div>
        ...
        <div class="col-5">
            <div class=" px-1">
                <div class="">
                   <p class="clearfix text-muted  px-2"><span> &copy; All rights reserved. Pacesetter Transport Services </span></p>
                </div>
            </div>
        </div>
        <div class="col-3">
            <div class="px-1">
                <div class="text-left">
                  <div class="">
                            <ul class="list-inline">
                                <a href=""><li class="list-inline-item red">Privacy</li></a>
                            </ul>
                        </div>
                </div>
            </div>
...
<!--     <div class="customizer border-left-blue-grey border-left-lighten-4 d-none d-sm-none d-md-block"><a class="customizer-close"><i class="ft-x font-medium-3"></i></a><a id="customizer-toggle-icon" class="customizer-toggle bg-danger"><i class="ft-settings font-medium-4 fa fa-spin white align-middle"></i></a>
    ...
    <!--  <script src="http://maps.googleapis.com/maps/api/js?key=AIzaSyBDkKetQwosod2SZ7ZGCpxuJdxY3kxo5Po"></script> -->
    <script src="app-assets/vendors/js/gmaps.min.js"></script>
